...
namespace PrinterServerAPI.lib
{
  /// <summary>
  ...
  public class ThermalPrinter
  {
    ...
    /// </param>
    public ThermalPrinter(SerialPort serialPort, byte maxPrintingDots, byte heatingTime, byte heatingInterval) => Constructor(serialPort, maxPrintingDots, heatingTime, heatingInterval);
    ...
    {
      Constructor(serialPort, _maxPrintingDots, _heatingTime, _heatingInterval);
    }
